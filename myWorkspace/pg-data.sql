...
insert into author (firstname, lastname) values ('J.R', 'Tolkien');
...
insert into reservation(book_id, member_id, pickupdate, returndate)
select 
    b.id as book_id, 
    m.id as member_id, 
    CURRENT_DATE + b.id * -INTERVAL '1 month' as pickupDate,
    CURRENT_DATE + b.id * -INTERVAL '1 month' + INTERVAL '7 days'
from book as b, member as m;

insert into Book_comments(book_id, member_id, date, text)
select
    book_id,
    member_id,
    returnDate,
